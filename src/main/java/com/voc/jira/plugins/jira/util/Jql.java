...
public class Jql {
	public static boolean isQueryValid(final String query, final SearchService searchService, final User user) {
		return searchService.parseQuery(user, query).isValid();
	}
	
	public static SearchResults getSearchResults(String query, Map<String, Object> context, final SearchService searchService, final User user, IErrorKeeper err) {
	...
	public static Query getQuery(String text, final SearchService searchService, final User user) {
